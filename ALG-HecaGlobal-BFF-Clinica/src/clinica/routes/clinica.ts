...
import controller from '../controllers/clinica';
 ...
 */
router.get('/listarestadocuota', auth, controller.listarestadocuota);
 ...
 */
 router.get('/listarestadofinanciamientosuperior', auth, controller.listarestadofinanciamientosuperior);
 ...
 *
 */
 router.post('/obtenerarchivo', auth, controller.obtenerarchivo);
 ...
 */
 router.get('/listarproductogarantia', auth, controller.listarproductogarantia);
 ...
 */
 router.get('/listarestadofinanciamiento', auth, controller.listarestadofinanciamiento);
 ...
 */
 ...
 router.post('/crearfinanciamiento', auth, controller.crearfinanciamiento);
 ...
 */
 ...
 router.post('/listarfinanciamientosproceso', auth, controller.listarfinanciamientosproceso);
 ...
 */
 ...
 router.post('/obtenerdatostratamiento', auth, controller.obtenerdatostratamiento);
 ...
 */
 ...
 router.post('/listarenproceso', auth, controller.listarenproceso);
 ...
 */
 ...
 router.post('/listarconfinanciamiento', auth, controller.listarconfinanciamiento);
 ...
 *
 */
router.put('/actualizarnotainterna', auth, controller.actualizarnotainterna);
 ...
 */
 ...
 router.post('/obtenerrutaarchivo', auth, controller.obtenerrutaarchivo);
 ...
 */
router.get('/usuario/getUsuarios', auth, controller.getUsuarios);
 ...
 */
 ...
 router.post('/usuario/validaringresousuario', controller.validaringresousuario);
 ...
 */
 ...
 router.post('/usuario/obtenerclaveusuario', controller.obtenerclaveusuario);
 ...
 *
 */
router.post('/generarpagare', auth, controller.generarPagare);
